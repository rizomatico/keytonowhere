...
// -- preloader image start
    ...
    var texture = PIXI.Texture.fromImage('001.png');

    // create a new Sprite using the texture
    var preloader = new PIXI.Sprite(texture);

    // create the texture on loading screen
    loadingScreen.addChild(preloader);
    ...
    preloader.position.x = this._renderer.width/2;
    preloader.position.y = this._renderer.height/2;

    // -- preloader image end

// -- animation loader
var textureb = PIXI.Texture.fromImage('loader.png');

// create a new Sprite using the texture
var bunny = new PIXI.Sprite(textureb);

// create the texture on loading screen
    loadingScreen.addChild(bunny);
...
// move the sprite to the center of the screen
    bunny.position.x = this._renderer.width/2;
    bunny.position.y = this._renderer.height/2;
